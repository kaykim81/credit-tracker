...
import { ArrowDownRight, ArrowUpRight, Trash2, Calendar, FileText } from "lucide-react";
...
export function TransactionList({ transactions, personId }: TransactionListProps) {
  ...
  // Sort transactions by date descending (assuming API doesn't guarantee order, though it should)
